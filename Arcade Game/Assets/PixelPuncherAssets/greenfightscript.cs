<<<<<<< HEAD:Arcade Game/Assets/fightgame/greenfightscript.cs
...
public class greenfightscript : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collider)
    {
        if (collider == enemyhit)
        {
            ...
            score = score + 100;
            fightscript.score = fightscript.score - 100;
            // if player has died, call gameover
            if (health == 0)
            {
...
>>>>>>> 4588cf3b674b6802fee727e8846abbd4a417e5e6:Arcade Game/Assets/PixelPuncherAssets/greenfightscript.cs
